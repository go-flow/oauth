...
var (
	...
	initCallbackMap      = map[string]func(client *http.Client, u *model.User){}
	initDefaultScopesMap = map[string][]string{}
)

func registerDriver(driver string, defaultscopes []string, callback func(client *http.Client, u *model.User), endpoint oauth2.Endpoint, apimap, usermap map[string]string) {
...
func InitializeDrivers(register func(driver string, defaultscopes []string, callback func(client *http.Client, u *model.User), endpoint oauth2.Endpoint, apimap, usermap map[string]string)) {
